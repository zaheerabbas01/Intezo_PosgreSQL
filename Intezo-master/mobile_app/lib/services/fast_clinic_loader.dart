...
class FastClinicLoader {
  ...
  static Future<Map<String, dynamic>?> loadClinicFast(String clinicId) async {
    try {
      ...
      final optimizedData = await OptimizedClinicService.getClinicComplete(clinicId);
  ...
  static Future<Map<String, dynamic>?> loadDoctorQueueFast(String clinicId, String doctorId) async {
    try {
      // Try optimized endpoint first
      final queueData = await OptimizedClinicService.getDoctorQueueFast(clinicId, doctorId);
