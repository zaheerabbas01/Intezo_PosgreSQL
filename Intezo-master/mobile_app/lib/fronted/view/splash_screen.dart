...
class _SplashScreenState extends State<SplashScreen> {
  ...
  Future<void> _initializeApp() async {
    try {
      ...
      print('🚀 Splash Screen: Login status checked - isLoggedIn: ${authProvider.isLoggedIn}');
      ...
      if (authProvider.isLoggedIn) {
        ...
        if (patientId != null) {
          print('🚀 Splash Screen: Force refreshing data for patient: $patientId');
      ...
      if (mounted) {
        print('🚀 Splash Screen: Navigating to ${authProvider.isLoggedIn ? "BottomNav" : "LoginScreen"}');
