...
await Provider.of<PatientProvider>(context, listen: false).refreshPremiumStatus();
Navigator.push(context, MaterialPageRoute(builder: (context) => const PremiumPaymentScreen()));
},
),
_buildDivider(isDarkMode),
_buildMenuItem(
...
SnackBar(content: Text('Premium status refreshed successfully')),
);
} catch (e) {
ScaffoldMessenger.of(context).showSnackBar(
SnackBar(content: Text('Error refreshing premium status: $e')),
);
}
},
),
