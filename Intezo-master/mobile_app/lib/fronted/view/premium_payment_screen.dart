    ...
    try {
      showDialog(
        ...
        builder: (context) => AlertDialog(
          ...
          title: Text('Select Image', style: TextStyle(color: colors().bluecolor1)),
          content: Column(
      ...
      builder: (context) => AlertDialog(
        ...
        title: Row(
          children: [
            ...
            SizedBox(width: 8),
            Text('Payment Submitted', style: TextStyle(color: colors().bluecolor1)),
          ],
        ),
        content: Text('Your payment has been submitted successfully. Please wait for admin approval to unlock premium features.'),
        actions: [
          TextButton(
            onPressed: () {
  ...
  Widget build(BuildContext context) {
    if (isLoading) {
      return Scaffold(
        ...
        body: Center(child: CircularProgressIndicator(color: colors().bluecolor1)),
      );
    }
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      SizedBox(width: 8),
                      Expanded(child: Text('Book unlimited queues at the same time')),
                    ],
                  ),
                  SizedBox(height: 8),
                  Row(
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      Icon(Icons.account_balance_wallet, color: Color(0xFF00A651), size: 20),
                      SizedBox(width: 8),
                      Text(
                        'Preferred: ',
                        style: TextStyle(
                  ...
                  GridView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return GestureDetector(
                        ...
                        child: Container(
                          decoration: BoxDecoration(
                            color: isSelected ? methodData['color'].withOpacity(0.1) : colors.bgColor,
                            border: Border.all(
                              color: isSelected ? methodData['color'] : Colors.grey.shade300,
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                ...
                                style: TextStyle(
                                  fontWeight: FontWeight.bold,
                                  color: isSelected ? methodData['color'] : Colors.black87,
                                ),
                              ),
                            ],
                          ),
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        borderRadius: BorderRadius.circular(12),
                        border: Border.all(color: colors().bluecolor1.withOpacity(0.3), width: 2),
                      ),
