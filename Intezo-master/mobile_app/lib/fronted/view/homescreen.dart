...
class _HomescreenState extends State<Homescreen> {
  ...
  Future<void> _startOptimizedLoading(ClinicProvider clinicProvider, PatientProvider patientProvider) async {
    try {
  ...
  Future<void> _checkPremiumStatus() async {
    try {
      ...
      if (data != null) {
        ...
        if (mounted) {
          Provider.of<PatientProvider>(context, listen: false).refreshPremiumStatus();
        }
      }
    } catch (e) {
              ...
              if (!isLoadingPremium && !isPremium && !hasPendingPayment)
                GestureDetector(
                  ...
                  child: Container(
                    ...
                    child: Row(
                      children: [
                        Icon(Icons.star_outline, color: colors().bluecolor1, size: 20),
                        SizedBox(width: 10),
                        Expanded(
                          child: Text(
