...
const Doctors = () => {
    ...
    const handleUpdateInModal = async (e) => {
        e.preventDefault();
        try {
            await updateDoctor(selectedDoctorForModal._id, formData);
            setShowSettingsInModal(false);
            fetchDoctors();
                                    ...
                                    <>
                                        ...
                                        <div className="doctors-grid">
                                            {availableDoctors.map(doctor => (
                                                <div key={doctor._id} className="doctor-option" onClick={() => selectDoctor(doctor)}>
                        ...
                        <div className="doctor-detail-content">
                            ...
                            <div className="modal-actions">
                                <button
                                    className="btn btn-info"
                                    onClick={() => {
                                        viewDoctorDashboard(selectedDoctorForModal._id);
                                ...
                                <button
                                    ...
                                    onClick={() => {
                                        toggleAvailability(selectedDoctorForModal._id, !selectedDoctorForModal.isAvailable);
                                        setShowDoctorModal(false);
                                    }}
                                >
                                ...
                                <button
                                    ...
                                    onClick={() => {
                                        handleDelete(selectedDoctorForModal._id);
                                        setShowDoctorModal(false);
                                    }}
                                >
                                    🗑️ Remove
