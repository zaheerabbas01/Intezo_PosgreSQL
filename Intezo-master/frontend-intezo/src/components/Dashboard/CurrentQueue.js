...
const CurrentQueue = ({ currentNumber, currentQueueId, onNext, onSkip, canCallNext, totalWaiting, nextPatientNumber, isLastPatient }) => {
  return (
    <div className="current-queue">
      ...
      <div className="queue-actions">
        ...
        >
          {canCallNext ? (
            <>
              <span>{isLastPatient ? 'Finish Patient' : 'Call Next Patient'}</span>
