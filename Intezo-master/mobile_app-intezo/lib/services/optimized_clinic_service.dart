...
class OptimizedClinicService {
  ...
  static Future<Map<String, dynamic>?> getClinicComplete(
    String clinicId, {
    ...
    try {
      ...
      if (!forceRefresh) {
        ...
        if (cachedData != null &&
            (now - cacheTime) < (_cacheValiditySeconds * 1000)) {
  ...
  static Future<Map<String, dynamic>?> getDoctorQueueFast(
    String clinicId,
    String doctorId,
  ) async {
    try {
  ...
  static Future<Map<String, dynamic>?> getBatchDoctorQueues(
    String clinicId,
    ...
    try {
      ...
      final response = await ApiService.post('clinics/$clinicId/batch-queues', {
        'doctorIds': doctorIds,
      }, isPublic: true);
  ...
  static Future<Map<String, dynamic>?> getClinicWithDoctors(
    String clinicId,
  ) async {
    try {
  ...
  static Future<Map<String, dynamic>?> getCachedClinicData(
    String clinicId,
  ) async {
    try {
      final prefs = await SharedPreferences.getInstance();
