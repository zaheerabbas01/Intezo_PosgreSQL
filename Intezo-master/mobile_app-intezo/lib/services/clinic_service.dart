...
class ClinicService {
  ...
  static Future<List<Map<String, dynamic>>> getClinics({
    ...
    try {
      ...
      if (!forceRefresh) {
        ...
        if (cachedData != null &&
            (now - cacheTime) < (_cacheValidityMinutes * 60 * 1000)) {
  ...
  static Future<List<Map<String, dynamic>>> getRecentClinics(
    ...
    try {
      ...
      if (cachedData != null && (now - cacheTime) < (2 * 60 * 1000)) {
        // 2 minute cache
  ...
  static Future<Map<String, dynamic>> getRealTimeQueue(
    String clinicId, {
    String? doctorId,
  }) async {
    try {
      print(
        'Getting real-time queue for clinic: $clinicId${doctorId != null ? ', doctor: $doctorId' : ''}',
      );
  ...
  static Future<Map<String, dynamic>> bookQueueNumber(
    String clinicId,
    String patientId, {
    String? doctorId,
    String? patientName,
